...
function ensureCloudinaryConfigured() {
    ...
    if (!cloudinaryName || !cloudinaryApiKey || !cloudinaryApiSecret) {
        throw new Error("Missing Cloudinary environment variables. Please set CLOUDINARY_NAME, CLOUDINARY_API_KEY, and CLOUDINARY_API_SECRET in your environment variables.");
    }
