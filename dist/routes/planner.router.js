...
class PlannerRouter {
    ...
    setupRoutes() {
        ...
        this.router.post("/activities/:id/assign-group-leader", auth_middleware_1.authenticate, (0, auth_middleware_1.authorizeWrite)(), (req, res, next) => {
            // Allow ADMIN and SUPERADMIN roles
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
        ...
        this.router.get("/group-leaders", auth_middleware_1.authenticate, (req, res, next) => {
            // Allow ADMIN and SUPERADMIN roles
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
        ...
        this.router.get("/mechanics-report/download/pdf", auth_middleware_1.authenticate, (req, res, next) => {
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
            }
        ...
        this.router.get("/mechanics-report/download/excel", auth_middleware_1.authenticate, (req, res, next) => {
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
            }
        ...
        this.router.get("/mechanics-report/:mechanicId/download/excel", auth_middleware_1.authenticate, (req, res, next) => {
            // Allow ADMIN and SUPERADMIN roles
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
        ...
        this.router.get("/mechanics-report/:mechanicId", auth_middleware_1.authenticate, (req, res, next) => {
            // Allow ADMIN and SUPERADMIN roles
            if (req.user?.role === "ADMIN" || req.user?.role === "SUPERADMIN") {
                next();
                return;
